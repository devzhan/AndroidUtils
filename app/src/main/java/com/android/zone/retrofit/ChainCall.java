...
//        if (mExecuting) {
//            NLog.w(TAG, "already executing, ignore it!!");
//            return;
//        }
//
...
//        NLog.v(TAG, "callFailed err=%d, cause=%s", err, extra_cause);
//        if (mRetry) {
...
//                NLog.w(TAG, "retry call: %d, times: %d", mLastRetryIndex, mRetryTimes);
